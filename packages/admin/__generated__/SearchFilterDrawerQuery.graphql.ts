...
export type SearchFilterDrawerQueryVariables = {};
export type SearchFilterDrawerQueryResponse = {
    readonly search: {
        readonly " $fragmentRefs": FragmentRefs<"SearchFilterFormFragment">;
    };
};
export type SearchFilterDrawerQuery = {
    readonly response: SearchFilterDrawerQueryResponse;
    readonly variables: SearchFilterDrawerQueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "ac622c7d3c2fea88c1af1c18cd9454dd",
    "id": null,
    "metadata": {},
    "name": "SearchFilterDrawerQuery",
    "operationKind": "query",
    "text": "query SearchFilterDrawerQuery {\n  search {\n    ...SearchFilterFormFragment\n  }\n}\n\nfragment SearchFilterBooleanFragment on SearchableProperty {\n  __isSearchableProperty: __typename\n  label\n  description\n  searchPath\n  searchOperators\n}\n\nfragment SearchFilterFormFragment on SearchScope {\n  coreProperties {\n    ... on SearchableProperty {\n      __isSearchableProperty: __typename\n      searchPath\n    }\n    ...SearchFilterFragment\n  }\n  schemas: availableSchemaVersions {\n    searchableProperties {\n      __typename\n      ... on SearchableProperty {\n        __isSearchableProperty: __typename\n        searchPath\n        label\n      }\n      ...SearchFilterFragment\n    }\n    id\n  }\n}\n\nfragment SearchFilterFragment on SearchableProperty {\n  __isSearchableProperty: __typename\n  ... on ScalarProperty {\n    __isScalarProperty: __typename\n    type\n  }\n  ...SearchFilterInputFragment\n  ...SearchFilterSelectFragment\n  ...SearchFilterBooleanFragment\n}\n\nfragment SearchFilterInputFragment on SearchableProperty {\n  __isSearchableProperty: __typename\n  label\n  description\n  searchPath\n  searchOperators\n}\n\nfragment SearchFilterSelectFragment on SearchableProperty {\n  __isSearchableProperty: __typename\n  label\n  description\n  searchPath\n  searchOperators\n  ... on SelectProperty {\n    options {\n      label\n      value\n    }\n  }\n}\n"
  }
};
})();
(node as any).hash = '7453d610cd7411b65b48f276ea64055c';
export default node;

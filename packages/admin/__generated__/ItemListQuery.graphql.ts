/**
 * @generated SignedSource<<47bd70ec2b5ad1e513c666f963ed760b>>
...
export type ItemListQuery$variables = {
  hasQuery: boolean;
...
export type ItemListQuery$data = {
  readonly search: {
...
export type ItemListQuery = {
  response: ItemListQuery$data;
  variables: ItemListQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "056d8a545cc573f89417bc8debf8f60a",
    "id": null,
    "metadata": {},
    "name": "ItemListQuery",
    "operationKind": "query",
...
(node as any).hash = "dc521087f908d49f89f11d90f389dbdc";

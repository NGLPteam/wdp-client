...
export type UserTypeaheadQueryVariables = {
    query: string;
};
export type UserTypeaheadQueryResponse = {
    readonly users: {
...
export type UserTypeaheadQuery = {
    readonly response: UserTypeaheadQueryResponse;
    readonly variables: UserTypeaheadQueryVariables;
};

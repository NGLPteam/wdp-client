...
export type communitiesListQuery$variables = {
  order?: EntityOrder | null | undefined;
  page: number;
};
export type communitiesListQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"CommunityListFragment">;
};
export type communitiesListQuery = {
  response: communitiesListQuery$data;
  variables: communitiesListQuery$variables;
};
...
(node as any).hash = "cffe536e4a4b9ff04c10f37e7bb3d441";

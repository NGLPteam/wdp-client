/**
 * @generated SignedSource<<7a52574d6072288f0c4f008210708281>>
...
export type itemsSlugItemsPagesQuery$variables = {
  hasQuery: boolean;
  itemSlug: string;
...
export type itemsSlugItemsPagesQuery$data = {
  readonly item: {
    readonly items: {
...
export type itemsSlugItemsPagesQuery = {
  response: itemsSlugItemsPagesQuery$data;
  variables: itemsSlugItemsPagesQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "f3f9748da51a83003713a8f0ddea53b5",
    "id": null,
    "metadata": {},
    "name": "itemsSlugItemsPagesQuery",
    "operationKind": "query",
...
(node as any).hash = "b27f3fa78f112330ce07da5d24da8e5d";

/**
 * @generated SignedSource<<e3ee49bbd9a218f4982192647df11348>>
...
export type pageTemplatesSearchCollectionQuery$variables = {
...
export type pageTemplatesSearchCollectionQuery$data = {
  readonly collection: {
    readonly " $fragmentSpreads": FragmentRefs<"SearchLayoutEntityFragment">;
  } | null | undefined;
};
export type pageTemplatesSearchCollectionQuery = {
  response: pageTemplatesSearchCollectionQuery$data;
  variables: pageTemplatesSearchCollectionQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "pageTemplatesSearchCollectionQuery",
    "selections": [
      {
        "alias": null,
        "args": (v6/*: any*/),

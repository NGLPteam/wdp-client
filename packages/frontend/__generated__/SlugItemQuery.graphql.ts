...
fragment IssueContentFragment_1jOQA9 on Collection {
  ...IssueSidebarNavFragment
  ordering(identifier: "articles") {
    ...IssueOrderingLayoutFragment_1jOQA9
    id
  }
}
...
fragment IssueOrderingLayoutFragment_1jOQA9 on Ordering {
  name
  header
  children(page: 1) {
    edges {
...
return {
  ...
  "params": {
    "cacheID": "0aa1ec3edc652c0496eafae047ed8be3",
    "id": null,
    "metadata": {},
    "name": "SlugItemQuery",
    "operationKind": "query",

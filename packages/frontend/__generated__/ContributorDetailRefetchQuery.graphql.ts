/**
 * @generated SignedSource<<13e48974d55b1ee3a8d013ad25689f68>>
...
export type ContributorDetailRefetchQuery$variables = {
  id: string;
  page?: number | null | undefined;
};
export type ContributorDetailRefetchQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"ContributorDetailFragment">;
  } | null | undefined;
};
export type ContributorDetailRefetchQuery = {
  response: ContributorDetailRefetchQuery$data;
  variables: ContributorDetailRefetchQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ContributorDetailRefetchQuery",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),

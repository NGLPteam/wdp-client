/**
 * @generated SignedSource<<fac38e2f230042d671515ca518ec6a96>>
...
export type AnnouncementSlugCollectionQuery$variables = {
  announcementSlug: string;
  slug: string;
};
export type AnnouncementSlugCollectionQuery$data = {
  readonly collection: {
    readonly community: {
      readonly " $fragmentSpreads": FragmentRefs<"AppLayoutCommunityFragment">;
    };
    readonly " $fragmentSpreads": FragmentRefs<"AppLayoutEntityFragment" | "EntityAnnouncementLayoutFactoryFragment" | "EntityLayoutFactoryFragment">;
  } | null | undefined;
};
export type AnnouncementSlugCollectionQuery = {
  response: AnnouncementSlugCollectionQuery$data;
  variables: AnnouncementSlugCollectionQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "dcf10356034f2eca824d0feb6046087e",
    "id": null,
    "metadata": {},
    "name": "AnnouncementSlugCollectionQuery",
    "operationKind": "query",
...
(node as any).hash = "d4d307636c1e7251388225301749a1da";

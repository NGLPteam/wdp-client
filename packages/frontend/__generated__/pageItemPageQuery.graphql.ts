/**
 * @generated SignedSource<<3739b22b94c15c46425285573d3c6e94>>
...
export type pageItemPageQuery$variables = {
  pageSlug: string;
  slug: string;
};
export type pageItemPageQuery$data = {
  readonly item: {
    readonly " $fragmentSpreads": FragmentRefs<"EntityPageLayoutFactoryFragment">;
  } | null | undefined;
};
export type pageItemPageQuery = {
  response: pageItemPageQuery$data;
  variables: pageItemPageQuery$variables;
};

/**
 * @generated SignedSource<<1b599c4436b80505a2d6fc326fda28d5>>
...
export type layoutTemplateQuery$variables = {
  slug: string;
};
export type layoutTemplateQuery$data = {
  readonly community: {
...
export type layoutTemplateQuery = {
  response: layoutTemplateQuery$data;
  variables: layoutTemplateQuery$variables;
};

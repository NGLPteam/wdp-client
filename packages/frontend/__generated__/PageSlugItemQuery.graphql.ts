/**
 * @generated SignedSource<<58c8351045b8f7157f9e0b26e58fee07>>
...
export type PageSlugItemQuery$variables = {
  pageSlug: string;
  slug: string;
};
export type PageSlugItemQuery$data = {
  readonly item: {
    readonly community: {
...
export type PageSlugItemQuery = {
  response: PageSlugItemQuery$data;
  variables: PageSlugItemQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "9b965b997d4f6c906cea4ed301421c85",
    "id": null,
    "metadata": {},
    "name": "PageSlugItemQuery",
    "operationKind": "query",
...
(node as any).hash = "1739c556539909d5ceafcdab21b047fa";

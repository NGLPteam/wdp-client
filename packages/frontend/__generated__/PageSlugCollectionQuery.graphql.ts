/**
 * @generated SignedSource<<00f4e3e04694b45d1f99d5a4491276ad>>
...
export type PageSlugCollectionQuery$variables = {
  pageSlug: string;
  slug: string;
};
export type PageSlugCollectionQuery$data = {
  readonly collection: {
...
export type PageSlugCollectionQuery = {
  response: PageSlugCollectionQuery$data;
  variables: PageSlugCollectionQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "853073c95c04c15563ccf080dfa43a1c",
    "id": null,
    "metadata": {},
    "name": "PageSlugCollectionQuery",
    "operationKind": "query",
...
(node as any).hash = "e8fc22574241a2dbab6058126e998662";

/**
 * @generated SignedSource<<a72d3bbbe2b339e63aec8dfd93f6fc86>>
...
export type pageCollectionPageQuery$variables = {
  pageSlug: string;
  slug: string;
};
export type pageCollectionPageQuery$data = {
  readonly collection: {
    readonly community: {
      readonly " $fragmentSpreads": FragmentRefs<"AppLayoutCommunityFragment">;
    };
    readonly " $fragmentSpreads": FragmentRefs<"AppLayoutEntityFragment" | "EntityLayoutFactoryFragment" | "EntityPageLayoutFactoryFragment">;
  } | null | undefined;
};
export type pageCollectionPageQuery = {
  response: pageCollectionPageQuery$data;
  variables: pageCollectionPageQuery$variables;
};

/**
 * @generated SignedSource<<1e6edf54a1f66082feb8217dfb27b000>>
...
export type ContributorCollectionDetailLayoutQuery$variables = {
  collection: string;
  slug: string;
};
export type ContributorCollectionDetailLayoutQuery$data = {
  readonly collection: {
    readonly community: {
...
export type ContributorCollectionDetailLayoutQuery = {
  response: ContributorCollectionDetailLayoutQuery$data;
  variables: ContributorCollectionDetailLayoutQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ContributorCollectionDetailLayoutQuery",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),

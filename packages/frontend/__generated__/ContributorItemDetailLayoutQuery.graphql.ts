/**
 * @generated SignedSource<<586eb97e6228807734da34ce304669b2>>
...
export type ContributorItemDetailLayoutQuery$variables = {
  item: string;
  slug: string;
};
export type ContributorItemDetailLayoutQuery$data = {
...
export type ContributorItemDetailLayoutQuery = {
  response: ContributorItemDetailLayoutQuery$data;
  variables: ContributorItemDetailLayoutQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ContributorItemDetailLayoutQuery",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),

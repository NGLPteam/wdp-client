...
fragment ArticleAnalyticsBlockFragment on Item {
  assetDownloadsByRegion(dateFilter: {}) {
    total
    results {
      countryCode
      regionCode
  ...
  entityViewsByRegion(dateFilter: {}) {
    total
    results {
      countryCode
      regionCode
...
return {
        ...
        "selections": [
          {
            ...
            "plural": false,
            "selections": (v5/*: any*/),
            "storageKey": "assetDownloadsByRegion(dateFilter:{})"
          },
          {
            "alias": null,
            "args": (v2/*: any*/),
            ...
            "plural": false,
            "selections": (v5/*: any*/),
            "storageKey": "entityViewsByRegion(dateFilter:{})"
          },
          (v6/*: any*/),
          {
            "alias": null,
  ...
  "params": {
    "cacheID": "bd670ab428eaadd1290871ba2efb4514",
    "id": null,
    "metadata": {},
    "name": "metricsSlugItemQuery",
    "operationKind": "query",
...
(node as any).hash = 'dfaa819e68157b4da3be372260f419c4';
export default node;

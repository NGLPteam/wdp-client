...
export type searchCollectionQueryResponse = {
    readonly collection: {
        readonly " $fragmentRefs": FragmentRefs<"EntityLayoutFactoryFragment" | "searchCollectionQueryFragment">;
    } | null;
...
fragment SearchLayoutFragment_Gvy7I on Searchable {
  ...
  search {
    results(query: "", page: 1, perPage: 20, predicates: [], order: PUBLISHED_ASCENDING) {
...
return {
  ...
  "params": {
    "cacheID": "f9ae2f56d55a10e4d705f5be93ba4d3c",
    "id": null,
    "metadata": {},
    "name": "searchCollectionQuery",
    "operationKind": "query",
...
(node as any).hash = '96d93feb44785c06c1479d978b68c486';
export default node;

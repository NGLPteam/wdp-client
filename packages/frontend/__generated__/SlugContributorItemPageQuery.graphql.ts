/**
 * @generated SignedSource<<634c0572d225ec3778ce7ae18a20c825>>
...
export type SlugContributorItemPageQuery$variables = {
  item: string;
  slug: string;
};
export type SlugContributorItemPageQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"ContributorItemDetailLayoutFragment">;
};
export type SlugContributorItemPageQuery = {
  response: SlugContributorItemPageQuery$data;
  variables: SlugContributorItemPageQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "5c7c7ab96790b7193b7496a3bdc45b14",
    "id": null,
    "metadata": {},
    "name": "SlugContributorItemPageQuery",
    "operationKind": "query",
